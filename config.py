...
CATEGORIES = {
    ...
    "SMM": {
        "name": "SMM & Content",
        "keywords": ["smm", "смм", "ведение", "контент", "стратеги", "инстаграм", "instagram", "соцсет"],
        "weight": 1.0
    },
    "LeadGen": {
        "name": "Lead Generation",
        "keywords": ["лидоген", "сбор лидов", "воронка", "воронки", "продаж", "трафик"],
        "weight": 1.1
    }
}
...
GLOBAL_STOP_WORDS = [
    ...
    "что делаю:", "результаты:", "опыт работы", "пишите в лс", "готов к тестовым" # Добавлено
]